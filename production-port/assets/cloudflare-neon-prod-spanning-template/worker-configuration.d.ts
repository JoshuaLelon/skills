/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a7d48d17ebbbe42bd9c81206cf437dd)
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<Cloudflare.Env, 'DATABASE_URL' | 'SESSION_SECRET' | 'ENVIRONMENT' | 'ANTHROPIC_API_KEY'>
		> {}
}
